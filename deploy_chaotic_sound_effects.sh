...
for site_file in index.html privacy.html sw.js manifest.webmanifest icon-192.png icon-512.png web.config sounds.pack VERSION; do
...
: > "$FAILURES"
{
  printf 'index.html\0privacy.html\0sw.js\0manifest.webmanifest\0icon-192.png\0icon-512.png\0web.config\0sounds.pack\0'
} > "$ALL_FILES"
...
verify_url "${LIVE}privacy.html" "/csfx/privacy.html"
